...
export type ToastEnterEvent = {
    target: HTMLDivElement;
    width: number;
    height: number;
};
export type ConfigArgs = Pick<ToastOptions, 'duration' | 'className' | 'clickClosable' | 'position' | 'maxVisibleToasts' | 'render' | 'theme' | 'zIndex' | 'isReversedOrder'> & {
    offsetX?: number;
    offsetY?: number;
    gap?: number;
};
...
export type ToastUpdateArgs = [message: ReactNode, duration?: ToastOptions['duration']] | [options: ToastUpdateOptions];
